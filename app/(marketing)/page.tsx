...
export default function Home() {
  return (
    ...
    <div className={cn("text-3xl md:text-6xl flex-col text-center text-neutral-800 mb-3", headingFont.className)}>
      ...
      <div className={cn("text-2xl md:text-3xl items-center mt-2 justify-center px-4 p-2 mx-auto w-fit rounded-md pb-4 bg-gradient-to-r from-blue-600 to-pink-500 text-white", headingFont.className)}>Empowering Work-Life Balance</div>
